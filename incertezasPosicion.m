...
Cm=Jac*Cparam*Jac';
 ...
 figure(4),hold on,subplot(1,2,1),hold on,plot(xm2,ym2,'r.')
 figure(4),hold on,subplot(1,2,1),hold on,plot(xm2(np),ym2(np),'ko')
 figure(4),hold on,plot_ellipse((Cm),[xm2(np),ym2(np)],'b-')
 xlim([0 110])
 ylim([0 110])
end