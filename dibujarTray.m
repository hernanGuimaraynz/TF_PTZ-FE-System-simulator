function [Xest,Yest,XestP,YestP ,t1,troi,dt1,QQ,Xest2,Yest2 ] = dibujarTray( Cc,TF,PARS,camara,r,nroROI ,COLOR)
...
plot(ypred5,ypred6,'m*','LineWidth',2),
  plot(ex2,ey2,'r*','LineWidth',2),
