function [Xest,Yest,ypred1,ypred2 ,t1,troi ] = dibujarTrayC( Cc,camara,r,nroROI )
...
t1=[0:0.002:6];%tiempo de simulacion de movimiento el auto
...
for n=1:length(exU)
 ...
 PosicionMundo(n,:) = camarafe_a_mundo_vect([alfa_fe beta_fe gama_fe xfeo yfeo zfeo],[exU(n) eyV(n)]);
 
 PosicionMundo2(n,:) = camarafe_a_mundo_vect([alfa_feR beta_feR gama_feR xfeoR yfeoR zfeoR],[exU(n) eyV(n)]);
end
