function [ ] = dibujarAutoM( Cc ,orientacion,camara,r,x,y)
...
plot3(A(1,:),A(2,:),A(3,:)),box on,xlim([0 x+50]),grid on,ylim([0 y+50]),xlim([0 110]),grid on,ylim([0 110])
% figure(figNum),subplot(1,2,1),hold on,plot(Xc,Yc,'bs','LineWidth',10),box on
